...
internal class StartupConfigReader(private val context: Context) {
    ...
    fun loadStartupConfig(): StartupPreferencesFacade.StartupConfig {
        ...
        val startupPreferences =
                StartupPreferencesFacade.StartupPreferences(
                        ...
                        wallpaperBackgroundAlpha =
                                run {
                                    val isDark = computeIsDarkMode(context, allPrefs)
                                    val key = if (isDark)
        ...
        return StartupPreferencesFacade.StartupConfig(
                oneHandedMode = oneHandedMode,
    ...
    internal fun computeIsDarkMode(context: Context, allPrefs: Map<String, *>): Boolean {
        val modeName =
                allPrefs[
    ...
    internal fun accentColorModeFromPrefs(allPrefs: Map<String, *>): AccentColorMode =
    ...
    internal fun customAccentColorArgbFromPrefs(allPrefs: Map<String, *>): Int =
            allPrefs[
                    com.tk.quicksearch.search.data.preferences.UiPreferences
