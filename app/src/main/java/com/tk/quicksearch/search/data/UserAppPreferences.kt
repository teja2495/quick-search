...
class UserAppPreferences(
        ...
        val startupPreferences =
            StartupPreferences(
                ...
                showSystemFiles =
                    allPrefs[
                        com.tk.quicksearch.search.data.preferences
                            .BasePreferences.KEY_SHOW_SYSTEM_FILES,
                    ] as?
                        Boolean
                        ?: false,
                showHiddenFiles =
                    allPrefs[
                        com.tk.quicksearch.search.data.preferences
                            .BasePreferences.KEY_SHOW_HIDDEN_FILES,
                    ] as?
                        Boolean
                        ?: false,
                excludedFileExtensions =
                ...
                overlayModeEnabled =
                    allPrefs[
                        com.tk.quicksearch.search.data.preferences
                            .UiPreferences.KEY_OVERLAY_MODE_ENABLED,
                    ] as?
                        Boolean
                        ?: false,
                directDialEnabled =
                ...
                amazonDomain =
                    allPrefs[
                        com.tk.quicksearch.search.data.preferences
                            .BasePreferences.KEY_AMAZON_DOMAIN,
                    ] as?
                        String,
                pinnedPackages =
                    allPrefs[
                ...
                suggestionHiddenPackages =
                    allPrefs[
                        com.tk.quicksearch.search.data.preferences
                            .BasePreferences.KEY_HIDDEN_SUGGESTIONS,
                    ] as?
                        Set<String>
                        ?: emptySet(),
                resultHiddenPackages =
                    allPrefs[
                        com.tk.quicksearch.search.data.preferences
                            .BasePreferences.KEY_HIDDEN_RESULTS,
                    ] as?
                        Set<String>
                        ?: emptySet(),
                recentSearchesEnabled =
    ...
    fun setRecentAppLaunches(packageNames: List<String>): List<String> = appPreferences.setRecentAppLaunches(packageNames)

    fun addRecentAppLaunch(packageName: String): List<String> = appPreferences.addRecentAppLaunch(packageName)
    ...
    fun getEnabledFileTypes(): Set<com.tk.quicksearch.search.models.FileType> = filePreferences.getEnabledFileTypes()

    fun setEnabledFileTypes(enabled: Set<com.tk.quicksearch.search.models.FileType>) = filePreferences.setEnabledFileTypes(enabled)

    fun clearEnabledFileTypes(): Set<com.tk.quicksearch.search.models.FileType> = filePreferences.clearEnabledFileTypes()
    ...
    fun removeExcludedAppShortcut(id: String): Set<String> = appShortcutPreferences.removeExcludedAppShortcut(id)

    fun clearAllExcludedAppShortcuts(): Set<String> = appShortcutPreferences.clearAllExcludedAppShortcuts()
    ...
    fun getAllAppShortcutNicknames(): Map<String, String> = nicknamePreferences.getAllAppShortcutNicknames()

    fun getAppShortcutNickname(shortcutId: String): String? = nicknamePreferences.getAppShortcutNickname(shortcutId)
    ...
    fun shouldForceSearchBarWelcomeOnNextOpen(): Boolean = uiPreferences.shouldForceSearchBarWelcomeOnNextOpen()

    fun setForceSearchBarWelcomeOnNextOpen(force: Boolean) = uiPreferences.setForceSearchBarWelcomeOnNextOpen(force)
    ...
    fun setHasSeenPersonalContextHint(seen: Boolean) = uiPreferences.setHasSeenPersonalContextHint(seen)
    ...
    fun getRecentItems(): List<com.tk.quicksearch.search.recentSearches.RecentSearchEntry> = recentSearchesPreferences.getRecentItems()

    fun addRecentItem(entry: com.tk.quicksearch.search.recentSearches.RecentSearchEntry) = recentSearchesPreferences.addRecentItem(entry)
    ...
    fun setRecentQueriesEnabled(enabled: Boolean) = recentSearchesPreferences.setRecentQueriesEnabled(enabled)
