    ...
    val (icon, tint) =
        when (method) {
            is ContactMethod.Phone -> {
                Pair(Icons.Rounded.Call, Color.White)
            }
            ...
            -> {
                Icon(
                    painter =
                        painterResource(
                            id = if (method is ContactMethod.WhatsAppVideoCall) R.drawable.whatsapp_video_call else R.drawable.whatsapp_call,
                        ),
                    contentDescription = null,
            ...
            -> {
                Icon(
                    painter =
                        painterResource(
                            id = if (method is ContactMethod.TelegramVideoCall) R.drawable.telegram_video_call else R.drawable.telegram_call,
                        ),
                    contentDescription = null,
                    tint = Color.Unspecified,
                    modifier = Modifier.size(24.dp),
            ...
            is ContactMethod.Email -> {
                Pair(Icons.Rounded.Email, Color.White)
            }
            ...
            is ContactMethod.CustomApp -> {
                Pair(Icons.Rounded.Person, Color.White)
            }
