...
internal object SearchStateExtractor {
    ...
    fun extractFeatureState(s: SearchUiState) =
        SearchFeatureState(
            ...
            activeLlmApiKeyLast4 = s.activeLlmApiKeyLast4,
            ...
            isSavingLlmApiKey = s.isSavingLlmApiKey,
            personalContext = s.personalContext,
            activeLlmModel = s.activeLlmModel,
            activeLlmGroundingEnabled = s.activeLlmGroundingEnabled,
            activeLlmThinkingEnabled = s.activeLlmThinkingEnabled,
            activeLlmAvailableModels = s.activeLlmAvailableModels,
