                        ...
                        Row(
                            ...
                            Switch(
                                    ...
                                    onCheckedChange = { enabled ->
                                        viewModel.setShowFolders(enabled)
                                    }
                            )
                        }
                    }
                                        ...
                                        Text(
                                                text =
                                                        when (fileType) {
                                                            FileType.DOCUMENTS ->
                                                                    stringResource(
                                                                            R.string.file_type_documents
                                                                    )
                                                            FileType.PICTURES ->
                                                                    stringResource(
                                                                            R.string.file_type_pictures
                                                                    )
                                                            FileType.VIDEOS ->
                                                                    stringResource(
                                                                            R.string.file_type_videos
                                                                    )
                                                            FileType.MUSIC ->
                                                                    stringResource(
                                                                            R.string.file_type_music
                                                                    )
                                                            FileType.APKS ->
                                                                    stringResource(
                                                                            R.string.file_type_apks
                                                                    )
                                                            FileType.OTHER ->
                                                                    stringResource(
                                                                            R.string.file_type_other
                                                                    )
                                                        },
                                                style = MaterialTheme.typography.bodyLarge,
                                                color = MaterialTheme.colorScheme.onSurface
