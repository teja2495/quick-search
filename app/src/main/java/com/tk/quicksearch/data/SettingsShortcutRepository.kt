...
class SettingsShortcutRepository(private val context: Context) {
    ...
    private fun MutableList<SettingShortcut>.addSystemDeviceShortcuts() {
        add(createShortcut(
            id = "system_settings",
    ...
    private fun MutableList<SettingShortcut>.addNetworkConnectivityShortcuts() {
        add(createShortcut(
            id = "wifi",
    ...
    private fun MutableList<SettingShortcut>.addSecurityPrivacyShortcuts() {
        add(createShortcut(
            id = "privacy",
    ...
    private fun MutableList<SettingShortcut>.addAppsPermissionsShortcuts(
        packageUri: String,
    ...
    private fun MutableList<SettingShortcut>.addBatteryPerformanceShortcuts() {
        add(createShortcut(
            id = "battery_saver",
    ...
    private fun MutableList<SettingShortcut>.addLanguageInputShortcuts() {
        add(createShortcut(
            id = "language_input",
    ...
    private fun MutableList<SettingShortcut>.addNotificationsAccessibilityShortcuts(packageUri: String) {
        add(createShortcut(
            id = "notifications",
    ...
    private fun MutableList<SettingShortcut>.addDeveloperShortcuts() {
        add(createShortcut(
