...
- **One-Hand Mode** - Position search results at the bottom of the screen for easier reach
...
- **Multiple Numbers** - When you open a contact result which has multiple phone numbers, the arrow beside phone number to access other numbers. The app will remember the last opened number and opens it first when you reopen the contact.
...
- **Pin Results** - Long press any result to pin it to the search home screen for quick access
- **Nicknames** - Long press any result to add a nickname, then search using that nickname in the future
...
- **Default Assistant** - Set Quick Search as your default assistant app to replace Gemini
- **Quick Settings Tile** - Add a Quick Search tile to notification quick settings for faster access
...
- **Mic Icon Action** - Choose what happens when tapping the mic:
  ...
  - Digital Assistant: Triggers device's digital assistant (Note: Gemini must be set as default assistant to trigger it)

## Support & Development

- **Send Feedback** - Submit feedback, bug reports, and feature requests via email from app settings
- **Rate App** - Rate Quick Search on the Play Store
- **View Source Code** - Access the Quick Search project's source code through the development option
